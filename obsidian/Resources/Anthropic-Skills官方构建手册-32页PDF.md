---
title: "Anthropic官方Skill构建手册：把Claude训练成团队成员"
type: Resource
original_url: https://resources.anthropic.com/hubfs/The-Complete-Guide-to-Building-Skill-for-Claude.pdf
source_title: "The Complete Guide to Building Skill for Claude"
...
# Anthropic官方Skill构建手册：把Claude训练成团队成员

## 内容摘要

1. **痛点背景**：每次打开新聊天都要从头解释偏好、公司风格、流程，32页手册正是为了解决这个重复劳动
2. **Skill定义**：Skill是一个文件夹，包含SKILL.md指令文件，告诉Claude如何处理特定任务，一次上传永久生效
3. **与MCP的关系**：MCP是厨房（工具），Skills是菜谱（步骤），有厨房没菜谱等于面对电器发呆
...
9. **五种编排模式**：顺序编排、多MCP协调、迭代精炼、上下文感知工具选择、领域特定智能
10. **开放标准**：Anthropic将Skills作为开放标准发布，与Asana、Canva、Figma、Sentry、Zapier等合作

## 我们可以做什么

1. **下载官方手册PDF**：获取32页原文，深入学习Skill构建方法
