...
# Code Factory：用代码契约实现 AI 自动代码生成和 Review

## Source
- Main URL: https://x.com/ryancarson/status/2023452909883609111
...
10. **关键是要定义"触发人工 Review 的条件"**：如涉及核心业务逻辑、支付等敏感操作
11. **契约需要持续迭代，让边界越来越清晰**
